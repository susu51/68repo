      ...
      <Dialog open={showAddForm} onOpenChange={setShowAddForm}>
        <DialogContent className="max-w-md mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Mevcut Konum Butonu - Prominent */}
            <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                <div>
                  <h4 className="font-semibold text-gray-900 text-sm">Hızlı Konum Ekle</h4>
                  <p className="text-xs text-gray-600 mt-1">GPS ile mevcut konumunuzu otomatik ekleyin</p>
                </div>
              </div>
              <Button
                type="button"
                ...
                className="w-full bg-orange-500 hover:bg-orange-600 text-white font-medium py-3 rounded-lg flex items-center justify-center gap-2 transition-all"
              >
              ...
              {(addressForm.lat && addressForm.lng) && (
                <div className="mt-3 p-2 bg-green-50 border border-green-200 rounded text-sm text-green-700 flex items-center gap-2">
                  ...
                  Konum alındı: {addressForm.lat.toFixed(6)}, {addressForm.lng.toFixed(6)}
                </div>
              )}
            </div>

            <div className="border-t pt-4">
              <p className="text-sm text-gray-500 mb-3">veya manuel olarak girin:</p>
            </div>
